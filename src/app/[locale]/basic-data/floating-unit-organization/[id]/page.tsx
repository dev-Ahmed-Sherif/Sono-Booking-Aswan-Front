import { getFloatingUnitOrganizationById } from "@/actions/basic-data/floatingUnitOrganizationService";
...
const FloatingUnitOrganizationIdPage = async ({ params }: PageProps) => {
  const { id } = params;
  let initialData: unknown = null;
  if (id && id !== "new") {
    const result = await getFloatingUnitOrganizationById(id);
...
export default FloatingUnitOrganizationIdPage;
