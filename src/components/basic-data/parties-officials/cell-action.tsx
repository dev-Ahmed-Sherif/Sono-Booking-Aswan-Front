...
import { PartiesOfficialColumn } from "@/components/basic-data/parties-officials/columns";
...
const CellAction = ({ data }: { data: PartiesOfficialColumn }) => {
    ...
    <>
      ...
      <div className="flex items-center justify-center gap-1">
        <Button
          ...
          onClick={() =>
            router.push(
              `/${params.locale}/basic-data/parties-officials/${data.id}`,
            )
          }
          title="تعديل"
        >
