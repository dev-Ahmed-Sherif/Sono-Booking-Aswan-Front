...
import CellAction from "@/components/basic-data/governorate/cell-action";
...
export function createColumns(
...
): ColumnDef<GovernorateColumn>[] {
  const base: ColumnDef<GovernorateColumn>[] = [
  ...
  const auditCols: ColumnDef<GovernorateColumn>[] = [
    {
