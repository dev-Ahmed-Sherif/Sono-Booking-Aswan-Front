...
import {
  TouristMarinaColumn,
  createColumns,
} from "@/components/basic-data/tourist-marinas/columns";
...
type ClientProps = { data: TouristMarinaColumn[] | null; path: string };
    ...
    <div className="mt-7 sm:mt-0 space-y-4">
      ...
      <div className="p-2 sm:p-4 flex flex-col sm:flex-row items-center sm:justify-between gap-3 sm:gap-4">
        <div className="w-full sm:w-auto text-center sm:text-right">
          <Heading title={`عدد البيانات (${tableData.length})`} description="إدارة المراسى السياحية" />
        </div>
