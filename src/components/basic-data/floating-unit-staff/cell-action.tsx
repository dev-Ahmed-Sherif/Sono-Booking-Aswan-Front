...
import { FloatingUnitStaffColumn } from "@/components/basic-data/floating-unit-staff/columns";
...
type CellActionProps = {
  data: FloatingUnitStaffColumn;
  onEditClick?: (data: FloatingUnitStaffColumn) => void;
        ...
        <Button
          ...
          onClick={() =>
            onEditClick
              ? onEditClick(data)
              : router.push(
                  `/${locale}/basic-data/floating-unit-staff/${data.id}`,
                )
          }
          title="تعديل"
        >
