...
type CellActionProps = { data: MaintenanceColumn };
...
const CellAction = ({ data }: CellActionProps) => {
  ...
  const onDelete = async () => {
    try {
      ...
      const deleteFn = superAdmin ? deleteMaintenanceById : softDeleteMaintenanceById;
    ...
    <>
      ...
      <div className="flex items-center justify-center gap-1">
        <Button
          ...
          size="icon"
          className="h-8 w-8"
          onClick={() => router.push(`/${locale}/operation/maintenance/${data.id}`)}
          title="تعديل"
        >
