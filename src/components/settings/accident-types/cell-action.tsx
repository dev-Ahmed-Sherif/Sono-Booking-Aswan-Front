...
import { AccidentTypeColumn } from "@/components/settings/accident-types/columns";
...
type CellActionProps = { data: AccidentTypeColumn };
    ...
    <>
      ...
      <div className="flex items-center justify-center gap-1">
        <Button
          ...
          className="h-8 w-8"
          onClick={() =>
            router.push(`/${params.locale}/settings/accident-types/${data.id}`)
          }
          title="تعديل"
        >
