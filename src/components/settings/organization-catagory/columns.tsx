...
import CellAction from "@/components/settings/organization-catagory/cell-action";

import { formatUtcToCairo } from "@/lib/date-timeOptions";

export type OrganizationCatagoryColumn = {
  id: string;
  nameAr: string;
  nameEn: string;
  isDeleted?: boolean;
...
export function createColumns(
...
): ColumnDef<OrganizationCatagoryColumn>[] {
  const base: ColumnDef<OrganizationCatagoryColumn>[] = [
    {
      accessorKey: "nameAr",
      header: "الاسم العربي",
    },
  ...
  const auditCols: ColumnDef<OrganizationCatagoryColumn>[] = [
    {
