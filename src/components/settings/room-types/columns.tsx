...
import CellAction from "@/components/settings/room-types/cell-action";
...
export function createColumns(showAuditColumns: boolean = false): ColumnDef<RoomTypeColumn>[] {
  const base: ColumnDef<RoomTypeColumn>[] = [
    { accessorKey: "nameAr", header: "الاسم العربي" },
    { accessorKey: "nameEn", header: "الاسم الإنجليزي" },
  ];

  const auditCols: ColumnDef<RoomTypeColumn>[] = [
    {
