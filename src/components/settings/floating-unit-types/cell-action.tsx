...
import { FloatingUnitTypeColumn } from "@/components/settings/floating-unit-types/columns";
    ...
    <>
      ...
      <div className="flex items-center justify-center gap-1">
        <Button
          ...
          onClick={() =>
            router.push(
              `/${params.locale}/settings/floating-unit-types/${data.id}`,
            )
          }
          title="تعديل"
        >
