...
import { RequestTypeColumn } from "@/components/settings/request-types/columns";

type CellActionProps = { data: RequestTypeColumn };
    ...
    <>
      ...
      <div className="flex items-center justify-center gap-1">
        <Button
          ...
          size="icon"
          className="h-8 w-8"
          onClick={() => router.push(`/${params.locale}/settings/request-types/${data.id}`)}
          title="تعديل"
        >
