...
import { RequestTypeColumn, columns } from "@/components/settings/request-types/columns";

type RequestTypeClientProps = {
  data: RequestTypeColumn[] | null;
  path: string;
};

const Client = memo(({ data, path }: RequestTypeClientProps) => {
...
Client.displayName = "RequestTypeClient";
