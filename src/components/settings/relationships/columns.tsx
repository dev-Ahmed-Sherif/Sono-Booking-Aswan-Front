...
import CellAction from "@/components/settings/relationships/cell-action";
...
export function createColumns(showAuditColumns: boolean = false): ColumnDef<RelationshipColumn>[] {
  const base: ColumnDef<RelationshipColumn>[] = [
    { accessorKey: "nameAr", header: "الاسم العربي" },
    { accessorKey: "nameEn", header: "الاسم الإنجليزي" },
  ];

  const auditCols: ColumnDef<RelationshipColumn>[] = [
    {
