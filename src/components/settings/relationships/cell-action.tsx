...
import { RelationshipColumn } from "@/components/settings/relationships/columns";

type CellActionProps = { data: RelationshipColumn };
    ...
    <>
      ...
      <div className="flex items-center justify-center gap-1">
        <Button
          ...
          size="icon"
          className="h-8 w-8"
          onClick={() => router.push(`/${params.locale}/settings/relationships/${data.id}`)}
          title="تعديل"
        >
