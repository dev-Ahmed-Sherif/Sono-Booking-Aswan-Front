...
import { TownColumn, columns } from "@/components/settings/towns/columns";

type TownClientProps = {
  data: TownColumn[] | null;
  path: string;
};

const Client = memo(({ data, path }: TownClientProps) => {
