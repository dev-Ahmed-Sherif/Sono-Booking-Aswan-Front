...
import CellAction from "@/components/settings/towns/cell-action";
...
export function createColumns(showAuditColumns: boolean = false): ColumnDef<TownColumn>[] {
  const base: ColumnDef<TownColumn>[] = [
    { accessorKey: "nameAr", header: "الاسم العربي" },
    { accessorKey: "nameEn", header: "الاسم الإنجليزي" },
  ];

  const auditCols: ColumnDef<TownColumn>[] = [
    {
