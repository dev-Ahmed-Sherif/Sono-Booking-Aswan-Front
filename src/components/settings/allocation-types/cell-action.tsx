...
import { AllocationTypeColumn } from "@/components/settings/allocation-types/columns";

type CellActionProps = { data: AllocationTypeColumn };
    ...
    <>
      ...
      <div className="flex items-center justify-center gap-1">
        <Button
          ...
          size="icon"
          className="h-8 w-8"
          onClick={() => router.push(`/${params.locale}/settings/allocation-types/${data.id}`)}
          title="تعديل"
        >
