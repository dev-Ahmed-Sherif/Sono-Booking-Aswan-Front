...
import { AllocationTypeColumn, createColumns } from "@/components/settings/allocation-types/columns";
import { useLocalStorage } from "@/hooks/useLocalStorage";
import { isSuperAdminRoleCandidates, RoleCandidates } from "@/lib/role-utils";

type AllocationTypeClientProps = {
  data: AllocationTypeColumn[] | null;
  path: string;
};

const Client = memo(({ data, path }: AllocationTypeClientProps) => {
...
Client.displayName = "AllocationTypeClient";
