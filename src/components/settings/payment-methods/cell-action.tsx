...
import { PaymentMethodColumn } from "@/components/settings/payment-methods/columns";

type CellActionProps = { data: PaymentMethodColumn };
    ...
    <>
      ...
      <div className="flex items-center justify-center gap-1">
        <Button
          ...
          size="icon"
          className="h-8 w-8"
          onClick={() => router.push(`/${params.locale}/settings/payment-methods/${data.id}`)}
          title="تعديل"
        >
