...
import {
  ...
  createColumns,
} from "@/components/settings/inspection-types/columns";
...
type ClientProps = {
  data: InspectionTypeColumn[] | null;
  path: string;
  backPath?: string;
...
const Client = memo(
  ...
  const resolvedBackPath = backPath ?? `/${locale}/settings`;
      ...
      <div className="p-2 sm:p-4 flex flex-col sm:flex-row items-center sm:justify-between gap-3 sm:gap-4">
        <div className="w-full sm:w-auto text-center sm:text-right">
          <Heading
            ...
            description="إدارة أنواع التفتيشات"
          />
        </div>
        <Button
