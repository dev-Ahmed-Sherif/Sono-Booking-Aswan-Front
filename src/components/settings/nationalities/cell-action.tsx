...
import { NationalityColumn } from "@/components/settings/nationalities/columns";
...
type CellActionProps = { data: NationalityColumn };
    ...
    <>
      ...
      <div className="flex items-center justify-center gap-1">
        <Button
          ...
          className="h-8 w-8"
          onClick={() =>
            router.push(`/${params.locale}/settings/nationalities/${data.id}`)
          }
          title="تعديل"
        >
