...
import { SailingRouteColumn } from "@/components/settings/sailing-routes/columns";
    ...
    <>
      ...
      <div className="flex items-center justify-center gap-1">
        <Button
          ...
          className="h-8 w-8"
          onClick={() =>
            router.push(`/${params.locale}/settings/sailing-routes/${data.id}`)
          }
          title="تعديل"
        >
