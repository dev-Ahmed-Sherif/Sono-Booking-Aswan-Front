...
import {
  AllowedDayBeforeReservationColumn,
  columns,
} from "@/components/settings/allowed-day-before-reservations/columns";

type AllowedDayBeforeReservationClientProps = {
  data: AllowedDayBeforeReservationColumn[] | null;
  path: string;
};

const Client = memo(({ data, path }: AllowedDayBeforeReservationClientProps) => {
...
Client.displayName = "AllowedDayBeforeReservationClient";
