...
import { AllowedDayBeforeReservationColumn } from "@/components/settings/allowed-day-before-reservations/columns";

type CellActionProps = { data: AllowedDayBeforeReservationColumn };
    ...
    <>
      ...
      <div className="flex items-center justify-center gap-1">
        <Button
          ...
          size="icon"
          className="h-8 w-8"
          onClick={() => router.push(`/${params.locale}/settings/allowed-day-before-reservations/${data.id}`)}
          title="تعديل"
        >
