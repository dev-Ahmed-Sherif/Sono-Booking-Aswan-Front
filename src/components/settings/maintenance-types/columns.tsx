...
import CellAction from "@/components/settings/maintenance-types/cell-action";

import { formatUtcToCairo } from "@/lib/date-timeOptions";

export type MaintenanceTypeColumn = {
  id: string;
  nameAr: string;
  nameEn: string;
  isDeleted?: boolean;
...
export function createColumns(
...
): ColumnDef<MaintenanceTypeColumn>[] {
  const base: ColumnDef<MaintenanceTypeColumn>[] = [
    {
      accessorKey: "nameAr",
      header: "الاسم العربي",
    },
  ...
  const auditCols: ColumnDef<MaintenanceTypeColumn>[] = [
    {
