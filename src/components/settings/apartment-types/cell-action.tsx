...
import { ApartmentTypeColumn } from "@/components/settings/apartment-types/columns";

type CellActionProps = { data: ApartmentTypeColumn };
    ...
    <>
      ...
      <div className="flex items-center justify-center gap-1">
        <Button
          ...
          size="icon"
          className="h-8 w-8"
          onClick={() => router.push(`/${params.locale}/settings/apartment-types/${data.id}`)}
          title="تعديل"
        >
