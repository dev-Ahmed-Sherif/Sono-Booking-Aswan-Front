...
import {
  InspectionColumn,
  createColumns,
} from "@/components/inspections/inspection/columns";
...
type ClientProps = {
  data: InspectionColumn[] | null;
  path: string;
  backPath?: string;
  editPathPrefix?: string;
  showEnvironmentalColumns?: boolean;
};
...
const Client = memo(
  ({
    ...
    path,
    backPath,
    editPathPrefix = "/inspections/inspection",
    showEnvironmentalColumns = false,
  }: ClientProps) => {
