...
import { InspectionFloatingUnitClauseColumn } from "@/components/inspections/inspection-floating-unit-clause/columns";
...
type CellActionProps = {
  data: InspectionFloatingUnitClauseColumn;
    ...
    <>
      ...
      <div className="flex items-center justify-center gap-1">
        <Button
          ...
          className="h-8 w-8"
          onClick={() =>
            router.push(`/${params.locale}${editPathPrefix}/${data.id}`)
          }
          title="تعديل"
        >
