...
import {
  InspectionClauseColumn,
  createColumns,
} from "@/components/inspections/inspection-clause/columns";
...
type ClientProps = {
  data: InspectionClauseColumn[] | null;
  path: string;
  backPath?: string;
...
const Client = memo(
  ({
    ...
    path,
    backPath,
    editPathPrefix = "/inspections/inspection-clause",
  }: ClientProps) => {
